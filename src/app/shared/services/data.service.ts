...
export class DataService {
  ...
  submitPaymentDepositForm(depositFormToPost) {
    ...
    return this.http.post(`${environment.apiUrl}payment/transaction`, depositFormToPost, {
      headers: this.httpOptions.headers,
      observe: "response",
    });
  ...
  updateSport(sport) {
    return this.http.put(`${environment.sportsApiUrl}sport/${sport.sportId}`, sport, {
      headers: this.httpOptions.headers,
      observe: "response",
    });
  }
  ...
  getDisbaledMatches( ) {
    return this.http.get<any>(
      `${environment.sportsApiUrl}deactivatedmatch`,
      { headers: this.httpOptions.headers, observe: "response" }
    );
  }
  ...
  getBetsForUserAndDate(
    ...
    return this.http.get<any>(
      ...
      `${environment.apiUrl}bet${"?StartDate=" +
        startDate +
        "&endDate=" +
        endDate +
        "&BetType=" +
  ...
  changeBetsOdds(betId, newRate) {
    // takes offset
    return this.http.post(`${environment.apiUrl}tool/${betId}/change/${newRate}`, {}, {
      headers: this.httpOptions.headers,
      observe: "response",
    });
  }
  ...
  setBetVoidMaster(modal) {
    // takes offset
    return this.http.post(`${environment.apiUrl}tool/${modal.id}/void`, {}, {
      headers: this.httpOptions.headers,
      observe: "response",
    });
  }
  ...
  setBetSelectionWin(betId,selectionId) {
    ...
    return this.http.post(`${environment.apiUrl}tool/${betId}/win/${selectionId}`, {}, {
      headers: this.httpOptions.headers,
      observe: "response",
    });
  }
  ...
  setBetSelectionLoss(betId,selectionId) {
    ...
    return this.http.post(`${environment.apiUrl}tool/${betId}/loss/${selectionId}`, {}, {
      headers: this.httpOptions.headers,
      observe: "response",
    });
  }
  ...
  setBetSelectionVoid(betId,selectionId) {
    ...
    return this.http.post(`${environment.apiUrl}tool/${betId}/void/${selectionId}`, {}, {
      headers: this.httpOptions.headers,
      observe: "response",
    });
  }
  ...
  setBetPayout(id) {
    return this.http.put(`${environment.apiUrl}office/${id}`, {}, {
      headers: this.httpOptions.headers,
      observe: "response",
    });
  }
  ...
  getCustomerSelectionsReport(startDate, endDate, userId, isActionDate) {
    ...
    return this.http.get<any>(
      `${
        environment.apiUrl
      }report/customer/selection?startDate=${startDate}&endDate=${endDate}&userId=${userId}&isActionDate=${isActionDate}`,
      {
        headers: this.httpOptions.headers,
      }
    );
  ...
  updatePayment(payment) {
    return this.http.put(`${environment.apiUrl}payment/${payment.id}`, payment, {
      headers: this.httpOptions.headers,
      observe: "response",
    });
  }
  ...
  getTelerikReport(isNew,leagues){
    return this.http.post<any>(
      `${environment.apiUrl}report/league/events/${isNew}`,leagues
      , {headers: this.httpOptions.headers, observe:'response'}
    );
  }
  ...
  addNewIP(IP){
    ...
    return this.http.post<any>(
      `${environment.apiUrl}risk/ip`,`\"${ipAddress}\"`
      , options
    );
  }
  ...
  getSettings() {
    return this.http.get<any>(
      `${environment.apiUrl}tool/settings`,
      { headers: this.httpOptions.headers, observe: "response" }
    );
  }
