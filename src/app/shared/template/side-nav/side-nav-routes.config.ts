...
export const NAVITEMS: SideNavInterface[] = [
  {
    path: '/home',
    title: 'Dashboard',
    iconTheme: 'outline',
...

  {
    ...
    submenu: [
      ...
      {
        path: '/risk-management/ip-restriction',
      ...
      {
        path: '/risk-management/login-ips',
        title: 'Login IPs',
        iconType: '',
        icon: '',
        iconTheme: '',
