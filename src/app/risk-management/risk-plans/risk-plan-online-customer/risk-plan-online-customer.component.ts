...
@Component({
  selector: 'app-risk-plan-online-customer',
  templateUrl: './risk-plan-online-customer.component.html',
  styleUrls: ['./risk-plan-online-customer.component.css'],
})
export class RiskPlanOnlineCustomerComponent implements OnInit {
