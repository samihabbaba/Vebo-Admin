...
@Component({
  selector: 'app-risk-plan-bet-office',
  templateUrl: './risk-plan-bet-office.component.html',
  styleUrls: ['./risk-plan-bet-office.component.css']
})
export class RiskPlanBetOfficeComponent implements OnInit {
